...
# Fig S1 nucleocytoplasmic QC

## RNAseq PC1 & PC2 gene loadings
...
untreated.nuc_vs_cyt.dep.pca.merged = plot_grid(
  ...
  untreated.nuc_vs_cyt.dep.pca.plot, 
  untreated.nuc_vs_cyt.dep.loadings.scatter, 
  nrow = 5, labels = "auto", rel_heights = c(1,0.7,1.5,1,1))
# untreated.nuc_vs_cyt.dep.pca.merged
ggsave(untreated.nuc_vs_cyt.dep.pca.merged, filename = here(proj_path,"mass-spec/figures/untreated.nuc_vs_cyt.dep.pca.merged.png"), height = 13.5, width = 9)
...
# Table S2 Transcript redistribution
...
# Fig S2 Whole cell Heatmap nuclear export & NPC
...
nuclear_export.markers.rnaseq.cluster.heatmap <- Heatmap(nuclear_export.l2fc.marker.mat, 
          ...
          right_annotation = rowAnnotation(markers = anno_block(gp = gpar(fill = rep("white",8)), labels = c("NPC\nBasket", "NPC\nOrganisation", "Nuclear\nPore","Export\nSignal","Carrier\nActivity","TREX", "RNA\nExport","Nuclear\nExport"), labels_gp = gpar(fontsize = 10), labels_rot = 0)), row_title = NULL,
          row_names_gp = gpar(fontsize = 6), #show_row_names = FALSE, 
...
ggsave(as.ggplot(nuclear_export.markers.rnaseq.cluster.heatmap), filename = here(proj_path,"expression/deseq2/nuclear_export.markers.rnaseq.cluster.heatmap.png"), width = 9.5, height = 14)
...
# Fig S3: Lineplot sequence features & GC content & PhastCons 
...
# Fig S5 Immunofluorescence TDP-43 FUS
...
# Fig S6 CLIP and fraction splicing

## countOverlaps regions
...
fraction_splicing.merged = plot_grid(
  ...
  plot_grid(whole_nuclear_cytoplasm_als_vs_ctrl.voila.deltapsi_correlation_ggheatmap, nuclear_cytoplasm_untreated_mutants_vs_ctrl.modulizer.bind.barplot, ncol = 2, labels = letters[6:7], rel_widths = c(1,3)),
  nrow = 2, rel_heights = c(0.8,1.2), labels = c("e",""))
# fraction_splicing.merged
clip_regions.fraction_splicing.merged = plot_grid(clip_regions.untreated.nuc_vs_cyt.als_vs_ctrl.violin.merged, fraction_splicing.merged, nrow = 2, rel_heights =c(1,1))
# clip_regions.fraction_splicing.merged
ggsave(clip_regions.fraction_splicing.merged, filename = here(proj_path, "expression/deseq2/clip_regions.fraction_splicing.merged.png"), height = 12, width = 10)

```


# Table S4B MAJIQ fractions
...
# Table S5 Protein mislocalisation
...
# Table S6A RNAct protein summarised
...
# Table S6B RNAct transcript summarised
...
# Fig S8 Heatmap nuclear export NPC proteins
...
ggsave(as.ggplot(nuclear_export.markers.mass_spec.cluster.heatmap), filename = here(proj_path,"expression/deseq2/nuclear_export.markers.mass_spec.cluster.heatmap.png"), width = 9.5, height = 13)
...
# Table S7A ML240 Transcript redistribution
...
# Fig S10 ML240 Transcript redistribution
...
# Fig S12 ML240 Protein mislocalisation
...
# Table S7C ML240 Protein mislocalisation
...
# Fig S13 Co-immunoprecipitation
...
# Table S8 Co-IP ML240 vs untreated
